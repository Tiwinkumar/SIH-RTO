...
$result = "INSERT INTO rtov1copy SELECT * FROM rtov1 WHERE cno='$crimenumber' AND vh=2 ";
//echo ("Success");
...
<div id="content">
  <form method="POST" action="editrtov2.php" enctype="multipart/form-data">
    ...
    <h3>Vehicle 2 DETAILS Editing FORM </h3> <br /> 
    <div>
