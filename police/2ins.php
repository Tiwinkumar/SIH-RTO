...
//$itotal = mysqli_real_escape_string($db, $_POST['itot']);
    ...
    $sql = "INSERT INTO basic (zone,dis,rto,unit,psta,cno,placeofaccident,latitude,longitude,ipc,ioth1,natureofaccident,ioth2,accidentdate,accidenttime,numberofvehiclesinvolved,collisiontype,coth,junctiontype,joth,junctioncontrol,jcoth,roadcategory,roth,roadnarrowing,rnoth,lightconditions,loth,climate,cloth) VALUES ('$zone', '$dis', '$rto', '$unit', '$psta', '$cno', '$placeofaccident', '$latitude', '$longitude', '$ipc', '$ioth1', '$natureofaccident', '$ioth2', '$accidentdate', '$accidenttime', '$numberofvehiclesinvolved', '$collisiontype', '$coth', '$junctiontype', '$joth', '$junctioncontrol', '$jcoth', '$roadcategory', '$roth', '$roadnarrowing', '$rnoth', '$lightconditions', '$loth', '$climate', '$cloth')";
