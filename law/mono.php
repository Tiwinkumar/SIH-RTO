...
$result = mysqli_query($mysqli, "SELECT * FROM courtlogin WHERE id='$id'");
...
//echo $status;
  // $sql = 'SELECT cno,accidentdate,psta,numberofvehiclesinvolved,status FROM basic  WHERE psta="$psta"';
   ...
   $sql= "SELECT b.psta,b.cno,b.accidentdate,b.numberofvehiclesinvolved,b.status FROM basic b WHERE dis='$dis'and status='Approved From Policestation'";
      ...
      if(mysqli_num_rows($result) > 0) {
         ...
         while($row = mysqli_fetch_array($result)){
            ...
            echo "<td><a href='rto.php?crimenumber=" . $row['cno'] . "'>RTO Details</a></td>";
             echo "<td><a href='test.php?crimenumber=" . $row['cno'] . "'>Assign lawyer</a></td>";
